...
def printRSstatus(line1 = None, line2 = None, line3 = None, line4 = None, line5 = None, line6 = None, offset = 0):
    if line1 != None:
    ...
    if line5 != None:
        print('\x1b[{};1H'.format(offset + 5))
        print(line5)
        
    if line6 != None:
        print('\x1b[{};1H'.format(offset + 6))
        print(line6)


def printNodeTable(entry1 = None, entry2 = None, entry3 = None, entry4 = None, entry5 = None, entry6 = None, entry7 = None, entry8 = None, offset = 0):
    vertical_offset = 13
    vertical_size = 13
    init()
    if entry1 != None:
        print ('\x1b[{};13H'.format(offset))
        #print('\x1b[;{}H'.format(vertical_offset + (0*vertical_size)))
        print(entry1)
    
    if entry2 != None:
#        print('\x1b[{};{}H'.format(offset,vertical_offset + (2*vertical_size)))
        print('\x1b[{};26H'.format(offset))
        #print('\x1b[;{}H'.format(vertical_offset + (1*vertical_size)))
        print(entry2)
        
    if entry3 != None:
#        print('\x1b[{};{}H'.format(offset,vertical_offset + (3*vertical_size)))
        print('\x1b[{};39H'.format(offset))
        #print('\x1b[;{}H'.format(vertical_offset + (2*vertical_size)))
        print(entry3)
        
    if entry4 != None:
#        print('\x1b[{};{}H'.format(offset,vertical_offset + (4*vertical_size)))
        print('\x1b[{};52H'.format(offset))
        #print('\x1b[;{}H'.format(vertical_offset + (3*vertical_size)))
        print(entry4)
        
    if entry5 != None:
#        print('\x1b[{};{}H'.format(offset,vertical_offset + (5*vertical_size)))
        print('\x1b[{};65H'.format(offset))
        #print('\x1b[;{}H'.format(vertical_offset + (4*vertical_size)))
        print(entry5)
        
    if entry6 != None:
#        print('\x1b[{};{}H'.format(offset,vertical_offset + (6*vertical_size)))
        print('\x1b[{};78H'.format(offset))
        #print('\x1b[;{}H'.format(vertical_offset + (5*vertical_size)))
        print(entry6)

    if entry7 != None:
#        print('\x1b[{};{}H'.format(offset,vertical_offset + (7*vertical_size)))
        print('\x1b[{};91H'.format(offset))
        #print('\x1b[;{}H'.format(vertical_offset + (6*vertical_size)))
        print(entry7)

    if entry8 != None:
#        print('\x1b[{};{}H'.format(offset,vertical_offset + (8*vertical_size)))
        print('\x1b[{};104H'.format(offset))
        #print('\x1b[1;{}H'.format(vertical_offset + (7*vertical_size)))
        print(entry8)
